...
(function() {
  ...
  CXT = {
    ...
    execSync: function(command, options) {
      ...
      //NOTE: Add sudo based on platform
      // if (process.platform == 'linux') {
      //   console.log('Adding sudo infront of:', command);
  ...
  module.exports = {
    ...
    connectToAP: function(_ap, cb) {
      var _msg, check_iface, error, error1, request_msg, t0;
      if (CXT.WiFiControlSettings.iface == null) {
    ...
    resetWiFi: function(cb) {
      var _msg, check_iface, error, error1, t0;
      try {
